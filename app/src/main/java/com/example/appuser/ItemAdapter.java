    ...
    public void onBindViewHolder(@NonNull ViewHolderItem holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start ItemDetailsActivity when an item is clicked
                Intent i = new Intent(itm_context, ItemDetailsActivity.class);
                i.putExtra("single_itm_image", model.getItm_productImage());
                i.putExtra("single_itm_headline", model.getItm_headline());
                i.putExtra("single_itm_price", model.getItm_price());
                i.putExtra("single_itm_brand", model.getItm_productBrand());
                i.putExtra("single_itm_category", model.getItm_category());
                i.putExtra("single_itm_description", model.getItm_description());
                itm_context.startActivity(i);
            }
        });
